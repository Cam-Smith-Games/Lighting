...
const maskCanvas = document.querySelector<HTMLCanvasElement>("#maskCanvas");
...
class CycleSetting {
    ...
    constructor(value: number, change: SettingChange) {
        this.value = value;
...
const input_settings: Record<string,string> = {
    fill_color: "#000000",
    fill_alpha: "0",
    light_color: "#ffffff",
    light_alpha: "200",
